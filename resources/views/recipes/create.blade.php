    ...
    <div class="card">
        ...
        <form action="{{ route('recipes.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="number" name="cooking_time" id="cooking_time" value="{{ old('cooking_time') }}" min="0">
            </div>

            <div class="form-group">
                <label for="portions">Portions</label>
                <input type="number" name="portions" id="portions" value="{{ old('portions') }}" min="1">
            </div>
            ...
            <div class="form-group">
                ...
                @for ($i = 0; $i < 5; $i++)
                    <div style="display: flex; gap: 8px; margin-bottom: 6px;">
                        <input type="text" name="ingredients[{{ $i }}][name]" placeholder="Ingredient name (e.g. Eggs)"
                            style="flex: 2;">
                        <input type="text" name="ingredients[{{ $i }}][quantity]" placeholder="Quantity (e.g. 2 pcs)"
                            style="flex: 1;">
                    </div>
                @endfor
            </div>
